// 中国行政区划数据（截至 2024 年）
// 来源：民政部公开数据 + 国家统计局区划代码
// 包含 34 个省级行政区及其下属地级市/区

export interface RegionEntry {
  /** 显示名（如 "北京市"、"朝阳区"）*/
  name: string;
  /** 拼音首字母（用于按字母排序等场景，暂未使用）*/
  pinyin?: string;
}
...
export const PROVINCES: Province[] = [
  { name: '北京市', cities: ['东城区', '西城区', '朝阳区', '海淀区', '丰台区', '石景山区', '门头沟区', '房山区', '通州区', '顺义区', '昌平区', '大兴区', '怀柔区', '平谷区', '密云区', '延庆区'] },
  ...
  { name: '重庆市', cities: ['渝中区', '江北区', '南岸区', '沙坪坝区', '九龙坡区', '大渡口区', '渝北区', '巴南区', '北碚区', '万州区', '涪陵区', '黔江区', '长寿区', '江津区', '合川区', '永川区', '南川区', '綦江区', '大足区', '璧山区', '铜梁区', '潼南区', '荣昌区', '开州区', '梁平区', '武隆区', '城口县', '丰都县', '垫江县', '忠县', '云阳县', '奉节县', '巫山县', '巫溪县', '石柱土家族自治县', '秀山土家族苗族自治县', '酉阳土家族苗族自治县', '彭水苗族土家族自治县'] },
  ...
  { name: '香港特别行政区', cities: ['中西区', '湾仔区', '东区', '南区', '油尖旺区', '深水埗区', '九龙城区', '黄大仙区', '观塘区', '葵青区', '荃湾区', '屯门区', '元朗区', '北区', '大埔区', '沙田区', '西贡区', '离岛区'] },
  { name: '澳门特别行政区', cities: ['花地玛堂区', '圣安多尼堂区', '大堂区', '望德堂区', '风顺堂区', '嘉模堂区', '圣方济各堂区', '路氹城'] },
];

/** 根据省名查找对应的城市列表，未找到返回空数组 */
